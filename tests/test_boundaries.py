...
# No .py-disabled files exist (all 9 grandfathered ones were resolved in
# IMPLEMENTATION_PLAN.md P3.4: 24_slice restored, the rest deleted as
# superseded). Fix or delete — never disable (change protocol §7).
_GRANDFATHERED_DISABLED: set[str] = set()
