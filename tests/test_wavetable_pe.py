...
class TestWavetablePELinearInterpolation:
    ...
    def test_integer_indices(self):
        ...
        np.testing.assert_array_almost_equal(
            snippet.data, np.full((10, 1), 5.0, dtype=np.float32), decimal=5
        )
    ...
    def test_fractional_indices(self):
        ...
        np.testing.assert_array_almost_equal(
            snippet.data, np.full((10, 1), 2.5, dtype=np.float32), decimal=5
        )
...
class TestWavetablePECubicInterpolation:
    ...
    def test_cubic_integer_indices(self):
        ...
        wt_pe = WavetablePE(wavetable, indexer, interpolation=InterpolationMode.CUBIC)
        self.renderer.set_source(wt_pe)
        ...
        np.testing.assert_array_almost_equal(
            snippet.data, np.full((10, 1), 5.0, dtype=np.float32), decimal=4
        )
    ...
    def test_cubic_smoother_than_linear(self):
        ...
        linear_pe = WavetablePE(
            wavetable, indexer, interpolation=InterpolationMode.LINEAR
        )
        cubic_pe = WavetablePE(
            wavetable, indexer, interpolation=InterpolationMode.CUBIC
        )
        ...
        np.testing.assert_array_almost_equal(
            linear_snippet.data, cubic_snippet.data, decimal=3
        )
...
class TestWavetablePEOutOfBounds:
    ...
    def test_zero_mode_out_of_bounds(self):
        ...
        wt_pe = WavetablePE(wavetable, indexer, out_of_bounds=OutOfBoundsMode.ZERO)
        self.renderer.set_source(wt_pe)
        ...
        np.testing.assert_array_almost_equal(
            snippet.data, np.zeros((10, 1), dtype=np.float32), decimal=5
        )
    ...
    def test_clamp_mode_high(self):
        ...
        wt_pe = WavetablePE(wavetable, indexer, out_of_bounds=OutOfBoundsMode.CLAMP)
        self.renderer.set_source(wt_pe)
    ...
    def test_wrap_mode(self):
        ...
        wt_pe = WavetablePE(
            cropped_wavetable, indexer, out_of_bounds=OutOfBoundsMode.WRAP
        )
        self.renderer.set_source(wt_pe)
        ...
        np.testing.assert_array_almost_equal(
            snippet.data, np.full((10, 1), 2.0, dtype=np.float32), decimal=4
        )
    ...
    def test_wrap_mode_negative(self):
        ...
        # Index -2 wraps to 8
        np.testing.assert_array_almost_equal(
            snippet.data, np.full((10, 1), 8.0, dtype=np.float32), decimal=4
        )
...
class TestWavetablePEArbitraryExtent:
    ...
    def test_wavetable_offset_start(self):
        ...
        np.testing.assert_array_almost_equal(
            snippet.data, np.full((10, 1), 50.0, dtype=np.float32), decimal=4
        )
