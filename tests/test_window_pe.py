    ...
    def test_max_of_constant(self):
        ...
        with self.renderer:
            ...
            np.testing.assert_array_almost_equal(
                snippet.data, np.full((100, 1), 0.5, dtype=np.float32), decimal=4
            )
...
class TestWindowPEMean:
    ...
    def test_mean_of_constant(self):
        ...
        with self.renderer:
            ...
            np.testing.assert_array_almost_equal(
                snippet.data, np.full((100, 1), 0.7, dtype=np.float32), decimal=4
            )
...
class TestWindowPERMS:
    ...
    def test_rms_of_constant(self):
        ...
        with self.renderer:
            ...
            np.testing.assert_array_almost_equal(
                snippet.data, np.full((100, 1), 0.6, dtype=np.float32), decimal=4
            )
...
class TestWindowPEMin:
    ...
    def test_min_of_constant(self):
        ...
        with self.renderer:
            ...
            np.testing.assert_array_almost_equal(
                snippet.data, np.full((100, 1), 0.4, dtype=np.float32), decimal=4
            )
