...
class TestTransformPEFunctions:
    ...
    def test_square_function(self):
        ...
        with self.renderer:
            ...
            np.testing.assert_array_almost_equal(
                snippet.data, np.full((100, 1), 4.0, dtype=np.float32), decimal=4
            )
    ...
    def test_sqrt_function(self):
        ...
        with self.renderer:
            ...
            # sqrt(4) = 2
            np.testing.assert_array_almost_equal(
                snippet.data, np.full((100, 1), 2.0, dtype=np.float32), decimal=4
            )
    ...
    def test_tanh_soft_clip(self):
        ...
        with self.renderer:
            ...
            # tanh(10) ≈ 1.0
            np.testing.assert_array_almost_equal(
                snippet.data, np.full((100, 1), 1.0, dtype=np.float32), decimal=4
            )
    ...
    def test_lambda_function(self):
        ...
        with self.renderer:
            ...
            # 3 * 2 + 1 = 7
            np.testing.assert_array_almost_equal(
                snippet.data, np.full((100, 1), 7.0, dtype=np.float32), decimal=4
            )
...
class TestTransformPEWithConversions:
    ...
    def test_ratio_to_db_transform(self):
        ...
        with self.renderer:
            ...
            np.testing.assert_array_almost_equal(
                snippet.data, np.full((100, 1), 20.0, dtype=np.float32), decimal=2
            )
    ...
    def test_pitch_to_freq_transform(self):
        ...
        with self.renderer:
            ...
            np.testing.assert_array_almost_equal(
                snippet.data, np.full((100, 1), 440.0, dtype=np.float32), decimal=2
            )
...
class TestTransformPEStereo:
    ...
    def test_stereo_transform(self):
        ...
        with self.renderer:
            ...
            np.testing.assert_array_almost_equal(
                snippet.data[:, 0], np.full(100, 4.0, dtype=np.float32), decimal=4
            )
            np.testing.assert_array_almost_equal(
                snippet.data[:, 1], np.full(100, 4.0, dtype=np.float32), decimal=4
            )
...
class TestTransformPEChaining:
    ...
    def test_chained_transforms(self):
        ...
        with self.renderer:
            ...
            np.testing.assert_array_almost_equal(
                snippet.data, np.full((100, 1), 9.0, dtype=np.float32), decimal=4
            )
