...
class TestDynamicsPEBasics:
    ...
    def test_auto_makeup_gain(self):
        ...
        envelope = ConstantPE(0.5)
        dynamics = DynamicsPE(
            source, envelope, threshold=-20, ratio=4, makeup_gain="auto"
        )
...
class TestDynamicsPECompression:
    ...
    def test_soft_knee_gradual_transition(self, renderer):
        ...
        # Hard knee
        dyn_hard = DynamicsPE(
            source, envelope, threshold=-20, ratio=4, knee=0, makeup_gain=0
        )
        ...
        # Soft knee (12dB)
        dyn_soft = DynamicsPE(
            source, envelope, threshold=-20, ratio=4, knee=12, makeup_gain=0
        )
