...
def main():
    ...
    # Match the render rate to the file's native rate before building the graph
    file_sr = WavReaderPE(sound_path).file_sample_rate
    ...
    duration_seconds = (extent.end - extent.start) / file_sr
