...
def demo_square():
    ...
    def square_wave():
        return pg.GainPE(pg.FunctionGenPE(F0, duty_cycle=0.5, waveform="rectangle"), 0.5)
...
def demo_pulse():
    ...
    def pulse_wave():
        return pg.GainPE(pg.FunctionGenPE(F0, duty_cycle=0.05, waveform="rectangle"), 0.5)
