...
class SpatialLinear(SpatialMethod):
    ...
    def __repr__(self) -> str:
        azimuth_str = (
            f"{self.azimuth:.1f}"
            if isinstance(self.azimuth, (int, float))
            else self.azimuth.__class__.__name__
        )
...
class SpatialHRTF(SpatialMethod):
    ...
    KEMAR_HRTF_ENTRIES = (
        ...
        (-40, 90, "H-40e090a.wav"),
        (-40, 96, "H-40e096a.wav"),
        (-40, 103, "H-40e103a.wav"),
        (-40, 109, "H-40e109a.wav"),
        (-40, 116, "H-40e116a.wav"),
        (-40, 122, "H-40e122a.wav"),
        (-40, 129, "H-40e129a.wav"),
        (-40, 135, "H-40e135a.wav"),
        (-40, 141, "H-40e141a.wav"),
        (-40, 148, "H-40e148a.wav"),
        (-40, 154, "H-40e154a.wav"),
        (-40, 161, "H-40e161a.wav"),
        (-40, 167, "H-40e167a.wav"),
        (-40, 174, "H-40e174a.wav"),
        (-40, 180, "H-40e180a.wav"),
        (-30, 0, "H-30e000a.wav"),
        (-30, 6, "H-30e006a.wav"),
        (-30, 12, "H-30e012a.wav"),
        (-30, 18, "H-30e018a.wav"),
        ...
        (-30, 90, "H-30e090a.wav"),
        (-30, 96, "H-30e096a.wav"),
        (-30, 102, "H-30e102a.wav"),
        (-30, 108, "H-30e108a.wav"),
        (-30, 114, "H-30e114a.wav"),
        (-30, 120, "H-30e120a.wav"),
        (-30, 126, "H-30e126a.wav"),
        (-30, 132, "H-30e132a.wav"),
        (-30, 138, "H-30e138a.wav"),
        (-30, 144, "H-30e144a.wav"),
        (-30, 150, "H-30e150a.wav"),
        (-30, 156, "H-30e156a.wav"),
        (-30, 162, "H-30e162a.wav"),
        (-30, 168, "H-30e168a.wav"),
        (-30, 174, "H-30e174a.wav"),
        (-30, 180, "H-30e180a.wav"),
        (-20, 0, "H-20e000a.wav"),
        (-20, 5, "H-20e005a.wav"),
        (-20, 10, "H-20e010a.wav"),
        (-20, 15, "H-20e015a.wav"),
        ...
        (-20, 90, "H-20e090a.wav"),
        (-20, 95, "H-20e095a.wav"),
        (-20, 100, "H-20e100a.wav"),
        (-20, 105, "H-20e105a.wav"),
        (-20, 110, "H-20e110a.wav"),
        (-20, 115, "H-20e115a.wav"),
        (-20, 120, "H-20e120a.wav"),
        (-20, 125, "H-20e125a.wav"),
        (-20, 130, "H-20e130a.wav"),
        (-20, 135, "H-20e135a.wav"),
        (-20, 140, "H-20e140a.wav"),
        (-20, 145, "H-20e145a.wav"),
        (-20, 150, "H-20e150a.wav"),
        (-20, 155, "H-20e155a.wav"),
        (-20, 160, "H-20e160a.wav"),
        (-20, 165, "H-20e165a.wav"),
        (-20, 170, "H-20e170a.wav"),
        (-20, 175, "H-20e175a.wav"),
        (-20, 180, "H-20e180a.wav"),
        (-10, 0, "H-10e000a.wav"),
        (-10, 5, "H-10e005a.wav"),
        (-10, 10, "H-10e010a.wav"),
        (-10, 15, "H-10e015a.wav"),
        ...
        (-10, 90, "H-10e090a.wav"),
        (-10, 95, "H-10e095a.wav"),
        (-10, 100, "H-10e100a.wav"),
        (-10, 105, "H-10e105a.wav"),
        (-10, 110, "H-10e110a.wav"),
        (-10, 115, "H-10e115a.wav"),
        (-10, 120, "H-10e120a.wav"),
        (-10, 125, "H-10e125a.wav"),
        (-10, 130, "H-10e130a.wav"),
        (-10, 135, "H-10e135a.wav"),
        (-10, 140, "H-10e140a.wav"),
        (-10, 145, "H-10e145a.wav"),
        (-10, 150, "H-10e150a.wav"),
        (-10, 155, "H-10e155a.wav"),
        (-10, 160, "H-10e160a.wav"),
        (-10, 165, "H-10e165a.wav"),
        (-10, 170, "H-10e170a.wav"),
        (-10, 175, "H-10e175a.wav"),
        (-10, 180, "H-10e180a.wav"),
        (0, 0, "H0e000a.wav"),
        (0, 5, "H0e005a.wav"),
        (0, 10, "H0e010a.wav"),
        (0, 15, "H0e015a.wav"),
    ...
    def __init__(self, azimuth: float | int, elevation: float | int = 0.0):
        if isinstance(azimuth, ProcessingElement) or isinstance(
            elevation, ProcessingElement
        ):
            raise ValueError(
    ...
    def _load_ir(self) -> tuple[np.ndarray, int]:
        ...
        if data.shape[1] != 2:
            raise ValueError(
                f"SpatialHRTF: expected stereo IR, got shape {data.shape} for {path}"
            )
    ...
    def __repr__(self) -> str:
        return (
            f"SpatialHRTF(azimuth={self.azimuth:.1f}, elevation={self.elevation:.1f})"
        )
